...
function LikeButton() {
    ...
    return (
        <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.push('Like')}>
          <Text style={{fontSize: 18, marginHorizontal: 10, marginVertical: 10}}>❤️</Text>
        </TouchableOpacity>
    );
}
...
function CafeButton() {
    ...
    return (
        <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.push('Cafe')}>
          <Text style={{fontSize: 40, marginHorizontal: 20, marginVertical: 10}}>🧁</Text>
...
function RestaurantButton() {
    ...
    return (
        <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.push('Restaurant')}>
          <Text style={{fontSize: 40, marginHorizontal: 23, marginVertical: 10}}>🍴</Text>
